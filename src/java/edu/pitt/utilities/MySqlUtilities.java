...
public class MySqlUtilities implements DbUtilities{
    ...
    private String dbName = "jcp65_bank1017"; // default database name
    private String dbUserName = "jcp65"; // login name for the database server
    private String dbPassword = "3179062"; // password for the database server
